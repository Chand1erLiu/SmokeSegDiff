...
from guided_diffusion.smoke5kloader import SMOKE5KDataset
...
def main():
    ...
    if args.data_name == 'ISIC':
        ...
        args.in_ch = 5
    elif args.data_name == 'SMOKE1K' or 'SMOKE5K':
        tran_list = [transforms.Resize((args.image_size,args.image_size)), transforms.ToTensor(),]
        transform_test = transforms.Compose(tran_list)

        ds = SMOKE5KDataset(args, args.data_dir, transform_test, mode='test')
        args.in_ch = 4
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        vutils.save_image(ensres, fp = args.out_dir + path[0].split('.')[0] +'_output_ens'+".jpg", nrow = 1, padding = 10)
